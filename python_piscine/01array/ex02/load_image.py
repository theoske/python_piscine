...
with open ("output.txt", "w") as file:
    file.write(str(ft_load("/Users/theoke/Dev/python_piscine/01array/ex02/landscape.jpg")))
with open ("output2.txt", "w") as file2:
    file2.write(str(ft_load("/Users/theoke/Dev/python_piscine/01array/ex02/animal.jpeg")))